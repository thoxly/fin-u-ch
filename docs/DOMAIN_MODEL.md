...
### GeneratedSalaryOperation (не реализовано в текущей версии)

**Примечание:** В текущей реализации система автоматически создает операции зарплаты через Worker App без создания служебных записей. Каждая зарплатная запись генерирует 3 операции:
