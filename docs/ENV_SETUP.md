...
**Примечание:** У вас 2 окружения - Development и Production. Staging не используется.
...
- [ENV Workflow](ENV_WORKFLOW.md) - Как работают env.example и .env (для новичков!)
