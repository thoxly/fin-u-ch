...
import { emailRateLimit } from '../../services/mail/rate-limit.middleware';
...
/**
 * @swagger
 * /api/auth/confirm-email-change-old:
 *   post:
 *     summary: Confirm old email for email change (public endpoint)
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
...
router.post(
  ...
  authController.confirmOldEmailForChange
);
 ...
 *   post:
 *     summary: Confirm new email and complete email change (public endpoint)
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *   post:
 *     summary: Accept user invitation and set password (public endpoint)
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
