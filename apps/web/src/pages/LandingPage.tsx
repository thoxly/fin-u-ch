        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-10 max-w-6xl mx-auto px-4">
          {[
            [
              ...
              'Поступления и списания ведутся вручную, а итоги не сходятся.',
            ],
            [
              '📅',
              'Сложно планировать',
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-10 max-w-6xl mx-auto px-4">
            {[
              [
                ...
                'Создайте структуру поступлений и списаний под свой бизнес.',
              ],
              [
                '2️⃣',
                'Вносите операции',
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-10 max-w-6xl mx-auto px-4">
          {[
            [
              '📊',
              'Дашборд',
              'Поступления, списания, остатки, чистый поток — в одном экране.',
            ],
            [
              '🧾',
              'План-факт анализ',
