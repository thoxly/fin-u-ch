        ...
        <div className="space-y-4">
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
            <p className="text-sm text-green-800 dark:text-green-200 mb-2">
              Пользователь <strong>{invitedUserEmail}</strong> успешно создан в
              системе.
            </p>
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              ⚠️ Этот пароль показывается только один раз. Убедитесь, что вы его
              сохранили.
            </p>
          </div>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-3">
            <p className="text-xs text-yellow-800 dark:text-yellow-200">
              <strong>Важно:</strong> Рекомендуется, чтобы пользователь изменил
              пароль при первом входе в систему.
            </p>
          </div>
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Это действие нельзя отменить. Пользователь будет деактивирован и не
