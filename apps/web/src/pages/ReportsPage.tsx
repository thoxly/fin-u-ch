...
import { MenuPopover } from '../shared/ui/MenuPopover';
import {
...
export const ReportsPage = () => {
  ...
  const reportMenuItems = [
    ...
    { id: 'dds', label: 'ДДС детально' },
  ];

  const budgetMenuItems = useMemo(() => {
          ...
          <div className="flex flex-wrap gap-4 items-end">
                ...
                trigger={
                  <button className="flex items-center gap-2 px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-900/50 transition-colors">
                    <span className="font-medium">
                      {reportMenuItems.find((item) => item.id === reportType)
                        ?.label || 'ДДС'}
                    </span>
            ...
            {reportType === 'cashflow' && (
              <div className="flex-shrink-0">
                ...
                <MenuPopover
                  items={budgetMenuItems}
                  trigger={
                    <button className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors min-w-[150px] justify-between">
                      <span className="font-medium">
