...
export const AccountBalancesChart: React.FC<AccountBalancesChartProps> = ({ data, className = '' }) => {
  ...
  const accountKeys = data && data.length > 0 ? Object.keys(data[0]).filter(key => key !== 'date' && key !== 'label') : [];
